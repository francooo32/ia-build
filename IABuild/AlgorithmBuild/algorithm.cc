...
void algorithm::find_knearest(data* query_point) 
{
...
void algorithm::set_training_data(std::vector<data*>* vector)
{
	training_data = vector;
}

void algorithm::set_test_data(std::vector<data*>* vector)
{
	test_data = vector;
}

void algorithm::set_validation_data(std::vector<data*>* vector)
{
	validation_data = vector;
}

void algorithm::set_k(int val)
{
	alg = val;
}

int algorithm::predict()
{
...
double algorithm::calculate_distance(data* query_point, data* input)
{
	double distance = 0.0;
	if (query_point->get_feature_vector() != input->get_feature_vector())
	{
...
double algorithm::validate_performance()
{
...
double algorithm::test_performance()
{
	double current_performance = 0;
	int count = 0;
...
int main()
{
	...
	algorithm* algorithm_nearest = new algorithm();
